...
_INPUTREADER_PREPROCESS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_outside_points', full_name='second.protos.InputReader.Preprocess.use_outside_points', index=22,
